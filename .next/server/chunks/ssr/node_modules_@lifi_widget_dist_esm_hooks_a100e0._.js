...
const useRouteExecution = ({ routeId, executeInBackground, onAcceptExchangeRateUpdate })=>{
    ...
    const executeRouteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: ()=>{
    ...
    const resumeRouteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
...
const useTokenBalances = (selectedChainId)=>{
    ...
    const { data: tokensWithBalance, isLoading: isBalanceLoading, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'token-balances',
            account.address,
            selectedChainId,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$hooks$2f$useBytecode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/wagmi/dist/esm/hooks/useBytecode.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$types$2f$src$2f$_esm$2f$chains$2f$Chain$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@lifi/types/src/_esm/chains/Chain.js [app-ssr] (ecmascript)");
;
;
const useIsContractAddress = (address, chainId, chainType)=>{
    const { data: contractCode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$hooks$2f$useBytecode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBytecode"])({
        address: address,
        chainId: chainId,
        query: {
            refetchInterval: 300000,
...
const useGasRefuel = ()=>{
    ...
    const isToContractAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$hooks$2f$useIsContractAddress$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIsContractAddress"])(effectiveToAddress, toChainId, toChain?.chainType);
...
const useRoutes = ({ observableRoute } = {})=>{
    ...
    const { data, isLoading, isFetching, isFetched, dataUpdatedAt, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey,
...
const useToAddressRequirements = ()=>{
    const { requiredUI } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$providers$2f$WidgetProvider$2f$WidgetProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWidgetConfig"])();
    const [fromChainId, toChainId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$stores$2f$form$2f$useFieldValues$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFieldValues"])('fromChain', 'toChain');
    const { chain: fromChain } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$hooks$2f$useChain$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChain"])(fromChainId);
    const { chain: toChain } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$hooks$2f$useChain$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChain"])(toChainId);
    const { account } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$wallet$2d$management$2f$dist$2f$esm$2f$hooks$2f$useAccount$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAccount"])({
        chainType: fromChain?.chainType
    });
    const isFromContractAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$widget$2f$dist$2f$esm$2f$hooks$2f$useIsContractAddress$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIsContractAddress"])(account.address, fromChainId, account.chainType);
...
const useGasSufficiency = (route)=>{
    ...
    const { data: insufficientGas, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
...
const useFromTokenSufficiency = (route)=>{
    ...
    const { data: insufficientFromToken, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
        ...
        refetchInterval,
        staleTime: refetchInterval,
        placeholderData: account.address ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["keepPreviousData"] : undefined
    });
    return {
...
const useAddressValidation = ()=>{
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTranslation"])();
    const { mutateAsync: validateAddress, isPending: isValidating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
...
const useTransactionHistory = ()=>{
    const { accounts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lifi$2f$wallet$2d$management$2f$dist$2f$esm$2f$hooks$2f$useAccount$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAccount"])();
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueries"])({
...
//# sourceMappingURL=node_modules_%40lifi_widget_dist_esm_hooks_a100e0._.js.map